...
public class MultipleRunways {
    ...
    public MultipleRunways(Flight[] flights, String[] runways, int reserveTime) {
    ...
    public static void main(String[] args) {
        ...
        String[] runways = new String[]{"A", "B"};
        int reserveTime = 600;

        MultipleRunways multipleRunways = new MultipleRunways(flights, runways, reserveTime);
